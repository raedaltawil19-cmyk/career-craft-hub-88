...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Smart CV — Your smart career workspace" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Smart CV — Your smart career workspace" },
      {
        ...
        content:
          "Build a Master CV, improve it with AI guidance, discover matching jobs and track every application.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Sora:wght@600;700;800&family=Manrope:wght@400;500;600;700;800&family=IBM+Plex+Sans+Arabic:wght@400;500;600;700&display=swap",
      },
