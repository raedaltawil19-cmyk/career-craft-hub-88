...
export default makeBundle({
  en: {
    cantTailorTitle: "Can't tailor yet",
    cantTailorDescription: "A Master CV and a selected job are both required for tailoring.",
    backToJobs: "Back to jobs",
    eyebrowTailoring: "{company} · from Master CV v{version}",
    heading: "Tailored CV",
    progressLabel: "Tailoring progress",
    stepAnalyze: "Analyze",
    stepCompare: "Compare",
    stepReview: "Review changes",
    stepGenerate: "Generate",
    analyzeTitle: "Analyze the posting",
    analyzeDescription:
      "The assistant reads the requirements and keywords for {title} at {company}.",
    analyzing: "Analyzing…",
    analyzeJob: "Analyze job",
    matchIntro:
      "Your Master CV against this posting. Nothing below invents experience you don't have.",
    strong: "Strong",
    transferable: "Transferable",
    missing: "Missing",
    seeProposedChanges: "See proposed changes",
    changesApproved:
      "{approved} of {total} changes approved. Nothing is applied until you generate.",
    sectionSummary: "Summary",
    sectionExperienceOrder: "Experience order",
    ...
    changeSkillsAfter: "{skills} first, then the rest",
    changeSkillsWhy: "Puts the employer's required skills where they are scanned first.",
    approved: "Approved",
    masterCv: "Master CV",
    tailored: "Tailored",
    approve: "Approve",
  ...
  sv: {
    ...
    heading: "Anpassat CV",
    progressLabel: "Anpassningsförlopp",
    stepAnalyze: "Analysera",
    stepCompare: "Jämför",
    ...
    missing: "Saknas",
    seeProposedChanges: "Visa föreslagna ändringar",
    changesApproved:
      "{approved} av {total} ändringar godkända. Inget tillämpas förrän du genererar.",
    sectionSummary: "Sammanfattning",
    sectionExperienceOrder: "Ordning på erfarenheter",
    ...
    approve: "Godkänn",
    skip: "Hoppa över",
    generateTailoredCv: "Generera anpassat CV",
  ...
  ar: {
    ...
    progressLabel: "مراحل التخصيص",
    stepAnalyze: "التحليل",
    stepCompare: "المقارنة",
    ...
    missing: "فجوات",
    seeProposedChanges: "عرض التعديلات المقترحة",
    changesApproved:
      "تمت الموافقة على {approved} من {total} تعديلات. لن يُطبَّق أي شيء قبل الإنشاء.",
    sectionSummary: "الملخص",
    sectionExperienceOrder: "ترتيب الخبرات",
    sectionSkills: "المهارات",
    changeSummaryAfter:
      "{title} بخبرة ثماني سنوات في التقنية المالية وبرمجيات B2B، مع تركيز على {keyword} والتسليم المتكامل للمنتجات كثيفة البيانات.",
    changeSummaryWhy:
    ...
    approve: "اعتماد",
    skip: "تخطٍّ",
    generateTailoredCv: "إنشاء السيرة المخصّصة",
